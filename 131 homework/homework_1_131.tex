...
\hypersetup{
  pdftitle={Homework 1},
  pdfauthor={Anna Bauer, Grant Cai, Alexis Navarra},
  hidelinks,
...
\NormalTok{algae\_new}\SpecialCharTok{$}\NormalTok{group }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(algae\_new}\SpecialCharTok{$}\NormalTok{speed,}
                         \FunctionTok{c}\NormalTok{(}\StringTok{"high"}\NormalTok{, }\StringTok{"medium"}\NormalTok{, }\StringTok{"low"}\NormalTok{))   }\CommentTok{\# Reorder factor levels to be in order}

\NormalTok{algae3 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(algae\_new, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{a3, }\AttributeTok{fill=}\NormalTok{ speed, group)) }\SpecialCharTok{+}  \CommentTok{\# use ggplot with a3}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"A conditioned Boxplot of Algal a3"}\NormalTok{) }\SpecialCharTok{+} \CommentTok{\#make title}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\CommentTok{\# make boxplot}

\NormalTok{algae3 }\CommentTok{\# display}
\end{Highlighting}
\end{Shaded}
