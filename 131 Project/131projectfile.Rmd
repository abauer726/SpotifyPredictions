...
pred.Ytrainknn = knn.reg(train = Xtrain, test = Xtrain, y = Ytrain, k = numneighbor)
head(pred.Ytrainknn)
# get training MSE
mean((pred.Ytrainknn$pred - Ytrain)^2)
...
head((pred.Ytestknn$pred - Ytest)^2)
mean((pred.Ytestknn$pred - Ytest)^2)
```
end adding kfold
